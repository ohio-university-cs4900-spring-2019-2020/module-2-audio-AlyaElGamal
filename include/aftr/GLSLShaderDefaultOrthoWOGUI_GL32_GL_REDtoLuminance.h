...
namespace Aftr
{
   ...
   class GLSLShaderDefaultOrthoWOGUI_GL32_GL_REDtoLuminance : public GLSLShader
   {
   public:
      static GLSLShaderDefaultOrthoWOGUI_GL32_GL_REDtoLuminance* New();
      virtual ~GLSLShaderDefaultOrthoWOGUI_GL32_GL_REDtoLuminance();
      virtual void bind( const Mat4& MVPMatrix, const ModelMeshSkin& skin );
      virtual void bind() override;

      GLSLShaderDefaultOrthoWOGUI_GL32_GL_REDtoLuminance& operator=( const GLSLShaderDefaultOrthoWOGUI_GL32_GL_REDtoLuminance& shader );
   ...
   protected:
      GLSLShaderDefaultOrthoWOGUI_GL32_GL_REDtoLuminance( GLSLShaderDataShared* dataShared );
      GLSLShaderDefaultOrthoWOGUI_GL32_GL_REDtoLuminance( const GLSLShaderDefaultOrthoWOGUI_GL32_GL_REDtoLuminance& );
   };
}
