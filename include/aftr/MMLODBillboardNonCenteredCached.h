...
namespace Aftr
{
   ...
   class MMLODBillboardNonCenteredCached : public ModelMeshLOD
   {
   public:
      MMLODBillboardNonCenteredCached( ModelMesh* parentMesh, Camera** camPtr, AftrFBOUserSpecifiedRenderTarget* fboTexGen );
      virtual ~MMLODBillboardNonCenteredCached();
      ...
      //virtual void renderMeshForTextureGeneration();
   ...
   GLfloat* getTightTextureCoordinates( int& size );
