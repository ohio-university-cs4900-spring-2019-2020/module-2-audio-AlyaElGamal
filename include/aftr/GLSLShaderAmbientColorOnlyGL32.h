...
namespace Aftr
{
   ...
   class GLSLShaderAmbientColorOnlyGL32 : public GLSLShader
   {
   public:
      static GLSLShaderAmbientColorOnlyGL32* New();
      virtual ~GLSLShaderAmbientColorOnlyGL32();
      virtual void bind( const Mat4& modelMatrix, const Mat4& normalMatrix, const Camera& cam, const ModelMeshSkin& skin );

      GLSLShaderAmbientColorOnlyGL32& operator=( const GLSLShaderAmbientColorOnlyGL32& shader );
   ...
   protected:
      GLSLShaderAmbientColorOnlyGL32( GLSLShaderDataShared* dataShared );
      GLSLShaderAmbientColorOnlyGL32(const GLSLShaderAmbientColorOnlyGL32&);
   };
}
