...
namespace Aftr
{
   ...
   class GLSLShaderDefaultGL32 : public GLSLShader
   {
   public:
      static GLSLShaderDefaultGL32* New();
      static GLSLShaderDefaultGL32* New( GLSLShaderDataShared* shdrData );
      virtual ~GLSLShaderDefaultGL32();
      virtual void bind( const Mat4& modelMatrix, const Mat4& normalMatrix, const Camera& cam, const ModelMeshSkin& skin );

      GLSLShaderDefaultGL32& operator=( const GLSLShaderDefaultGL32& shader );
   ...
   protected:
      GLSLShaderDefaultGL32( GLSLShaderDataShared* dataShared );
      GLSLShaderDefaultGL32(const GLSLShaderDefaultGL32&);
   };
}
