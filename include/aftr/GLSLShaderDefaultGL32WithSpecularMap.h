...
namespace Aftr
{
   ...
   class GLSLShaderDefaultGL32WithSpecularMap : public GLSLShader
   {
   public:
      static GLSLShaderDefaultGL32WithSpecularMap* New();
      virtual ~GLSLShaderDefaultGL32WithSpecularMap();
      virtual void bind( const Mat4& modelMatrix, const Mat4& normalMatrix, const Camera& cam, const ModelMeshSkin& skin );

      GLSLShaderDefaultGL32WithSpecularMap& operator=( const GLSLShaderDefaultGL32WithSpecularMap& shader );
   ...
   protected:
      GLSLShaderDefaultGL32WithSpecularMap( GLSLShaderDataShared* dataShared );
      GLSLShaderDefaultGL32WithSpecularMap(const GLSLShaderDefaultGL32WithSpecularMap&);
   };
}
