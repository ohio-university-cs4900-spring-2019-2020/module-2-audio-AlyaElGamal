...
namespace Aftr
{
   ...
   class GLSLShaderPerVertexColorGL32 : public GLSLShader
   {
   public:
      static GLSLShaderPerVertexColorGL32* New();
      virtual ~GLSLShaderPerVertexColorGL32();
      virtual void bind( const Mat4& modelMatrix, const Mat4& normalMatrix, const Camera& cam, const ModelMeshSkin& skin );

      GLSLShaderPerVertexColorGL32& operator=( const GLSLShaderPerVertexColorGL32& shader );
   ...
   protected:
      GLSLShaderPerVertexColorGL32( GLSLShaderDataShared* dataShared );
      GLSLShaderPerVertexColorGL32(const GLSLShaderPerVertexColorGL32&);
   };
}
