...
public:
   ...
   NetMessengerServerSession( boost::asio::io_context& io_context, NetMessengerMessageQueue* servListenerRecvQueue );
   ...
   NetMessengerServerSession( const std::string& host, const std::string& port, boost::asio::io_context& io_context,
   ...
   //Ownership is transferred to the NetMessengerServerSession, the message will be destroyed by this instance.
