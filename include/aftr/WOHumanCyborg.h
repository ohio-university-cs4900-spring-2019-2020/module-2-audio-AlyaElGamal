...
class WOHumanCyborg : public WOHuman
{

public:

   /**
      WOHumanCyborg constructor.
      ...
      \see WOBoundingShell
   */
   static WOHumanCyborg* New( const Vector& lxlylz, float mass );

   virtual ~WOHumanCyborg();

protected:
   WOHumanCyborg( float mass );
