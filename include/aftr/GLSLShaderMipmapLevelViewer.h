...
class GLSLShaderMipmapLevelViewer: public GLSLShader
{
public:
   static GLSLShaderMipmapLevelViewer* New( GLSLShaderDataShared* dataShared, float lodLevel, float texSizeXInPixels, float texSizeYInPixels );
   virtual ~GLSLShaderMipmapLevelViewer();

   GLSLShaderMipmapLevelViewer& operator =( const GLSLShaderMipmapLevelViewer& shader );
   ...
   */
   ...
   void setLODLevel( float lodLevel ) { this->lodLevel = lodLevel; }

   virtual void bind();
   virtual void unbind();

protected:
   GLSLShaderMipmapLevelViewer( GLSLShaderDataShared* dataShared, float lodLevel, float texSizeXInPixels, float texSizeYInPixels );
   GLSLShaderMipmapLevelViewer( const GLSLShaderMipmapLevelViewer& toCopy );
   float lodLevel;
   Vector texSize;
