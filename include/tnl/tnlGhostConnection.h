...
public:
   ...
   enum GhostConstants {
      GhostIdBitSize = 18,            ///< Size, in bits, of the integer used to transmit ghost IDs
      GhostLookupTableSizeShift = 18, ///< The size of the hash table used to lookup source NetObjects by remote ghost ID is 1 << GhostLookupTableSizeShift.
      ...
      GhostIdBitCount = 5, ///< Fewest number of bits needed to encode GhostIdBitSize
