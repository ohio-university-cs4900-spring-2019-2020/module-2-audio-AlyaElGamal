...
message( STATUS "[ ${CMAKE_CURRENT_LIST_FILE}:${CMAKE_CURRENT_LIST_LINE} ] "
                 "Inside of FindGDAL.cmake... Searching for GDAL..." )
...
IF( WIN32 )
   ...
   IF( MSVC )
      FIND_PATH( GDAL_INCLUDE_DIR gdal.h
         ...
         $ENV{INCLUDE} 
         PATHS
         "${AFTR_3RD_PARTY_INCLUDE_ROOT}/gdal-1.11.0"
      )
      FIND_LIBRARY( GDAL_LIBRARY
         ...
         PATHS "$ENV{LIB_DIR}/lib"
               ...
               DOC "Windows GDAL Library Location"
      )
  ...
  IF(UNIX) 
   ...
   IF( NOT GDAL_INCLUDE_DIR OR NOT GDAL_LIBRARY OR NOT GDAL_CONFIG )
      ...
      IF( GDAL_CONFIG )
        ...
        IF( GDAL_VERSION_MAJOR LESS 1 AND GDAL_VERSION_MINOR LESS 4 )
            MESSAGE (FATAL_ERROR "GDAL version is too old (${GDAL_VERSION}). Use 1.4.0 or higher.")
        ENDIF( GDAL_VERSION_MAJOR LESS 1 AND GDAL_VERSION_MINOR LESS 4 )
...
IF( GDAL_FOUND )
   IF( NOT GDAL_FIND_QUIETLY )
      MESSAGE( STATUS "Found GDAL_INCLUDE_DIR=${GDAL_INCLUDE_DIR}" )
      MESSAGE( STATUS "Found GDAL_LIBRARY=${GDAL_LIBRARY}" )
   ENDIF(NOT GDAL_FIND_QUIETLY)
ELSE()
   MESSAGE(GDAL_INCLUDE_DIR=${GDAL_INCLUDE_DIR})
   MESSAGE(GDAL_LIBRARY=${GDAL_LIBRARY})
   MESSAGE(WARNING "Could not find GDAL")
ENDIF()