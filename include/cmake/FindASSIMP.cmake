...
if(WIN32)
	...
	find_path(ASSIMP_INCLUDE_DIR
		...
		HINTS
			...
			${AFTR_3RD_PARTY_INCLUDE_ROOT}/assimp-3.3.1/include
	)
	...
	if(MSVC12 OR MSVC14)
		...
		find_path(ASSIMP_LIBRARY_DIR
			...
			HINTS
        ${AFTR_ENGINE_ROOT_DIR}/lib${AFTR_NBITS}
				${ASSIMP_ROOT_DIR}/lib${ASSIMP_ARCHITECTURE}
		)
		
		find_library(ASSIMP_LIBRARY_RELEASE				assimp-${ASSIMP_MSVC_VERSION}-mt.lib 			PATHS ${ASSIMP_LIBRARY_DIR})
		find_library(ASSIMP_LIBRARY_DEBUG				assimp-${ASSIMP_MSVC_VERSION}-mt_d.lib			PATHS ${ASSIMP_LIBRARY_DIR})
	...
	if( assimp_INCLUDE_DIR )
		...
		message( STATUS "DID NOT Found include..." )
